...
public class DeviceService {
    ...
    public void addToPool(final Long userId, final String deviceCode) throws SystemException {
        DeviceService.logger.debug(String.format("Adding device to pool list with userId: %d and device code: '%s'", userId, deviceCode));
    ...
    public Connection getConnection(final String deviceCode) throws NotFoundException {
        DeviceService.logger.debug(String.format("getting device connection for device code: '%s'", deviceCode));
    ...
    public void setStatusReady(final DeviceEntity device) {
        DeviceService.logger.debug(String.format("Authorizing device: '%s'", device));
