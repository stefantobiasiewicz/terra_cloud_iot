...
public interface DeviceRepository extends JpaRepository<DeviceEntity, Long> {
    ...
    Optional<DeviceEntity> findByFactoryCodeAndNotDeleted(@Param("code") final String code);
    ...
    Optional<DeviceEntity> findByDeviceMqttAndNotDeleted(@Param("toDeviceTopic") String toDeviceTopic, @Param("toServiceTopic") String toServiceTopic);
    ...
    List<DeviceEntity> findAllByUserIdAndNotDeleted(Long userId);
    ...
    List<DeviceEntity> findAllByUserIdAndIdAndNotDeleted(@Param("userId") Long userId, @Param("deviceId")  Long deviceId);

    @Query(value = "Select d from DeviceEntity d where d.status != pl.terra.cloud_iot.jpa.entity.enums.DeviceStatus.DELETED")
    List<DeviceEntity> findAllNotDeleted();
